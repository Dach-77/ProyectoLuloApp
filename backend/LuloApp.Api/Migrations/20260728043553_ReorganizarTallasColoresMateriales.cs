...
{
    /// <inheritdoc />
    public partial class ReorganizarTallasColoresMateriales : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductoMateriales", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("c0000000-0000-0000-0000-000000000001"), new Guid("11111111-1111-1111-1111-111111111111"), "Lino" },
                    { new Guid("c0000000-0000-0000-0000-000000000002"), new Guid("22222222-2222-2222-2222-222222222222"), "Lana" },
                    { new Guid("c0000000-0000-0000-0000-000000000003"), new Guid("33333333-3333-3333-3333-333333333333"), "Lana" },
                    { new Guid("c0000000-0000-0000-0000-000000000004"), new Guid("44444444-4444-4444-4444-444444444444"), "Lino" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductoMateriales_ProductoId",
                table: "ProductoMateriales",
                column: "ProductoId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Material", "Tallas" },
                values: new object[] { "Lino", "S,M,L,XL" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Material", "Tallas" },
                values: new object[] { "Lana", "S,M,L,XL" });
